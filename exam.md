...
The certification consists on **ONE** exams.

* The exam **MD-100 (Windows Client)** measures your ability to accomplish the following technical tasks: deploy Windows client; manage identity and compliance; manage, maintain, and protect devices; and manage applications. 

    - [MD-102 exam page](https://learn.microsoft.com/en-us/credentials/certifications/exams/md-102/)

    - [Exam skills measured](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/md-102)


<br/>

You can explore steps to get certified as an **Microsoft 365 Certified: Endpoint Administrator Associate** and review the resources available to help you prepare [**here**](https://learn.microsoft.com/en-us/credentials/certifications/m365-endpoint-administrator/)
...
The exam measured skills are constantly being updated due to dynamic cloud services. So it is highly recommended to always consult the official exam page [**here**](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/md-102).
...
- [Practice Assessments for MD-102: Endpoint Administrator](https://learn.microsoft.com/en-us/credentials/certifications/exams/md-102/practice/assessment?assessment-type=practice&assessmentId=76)
...
- [Measureup](https://www.measureup.com/practice-test-md-102-endpoint-administrator-exam.html#u5).
- [Mindhub](https://www.mindhub.com/md-102-endpoint-administrator-microsoft-certification-practice-test/p/MU-MD-102).
